    ...
    override suspend fun doWork(): Result {
        return try {
            setForegroundService(
                ...
                message = applicationContext.getString(R.string.upload_starting)
            )
                ...
                setForegroundService(
                    context = applicationContext,
                    message = applicationContext.getString(R.string.upload_successful)
                )
                Result.success(
                    workDataOf(
            ...
            setForegroundService(
                context = applicationContext,
                message = applicationContext.getString(R.string.upload_failed)
            )
            Result.failure(
                workDataOf(
